...
* [Даигностика проблем](faq/troubleshooting/README.md)
  ...
  * [Подключение к АТС с помощью SSH](faq/troubleshooting/podklyuchenie-k-ats-s-pomoshyu-ssh/README.md)
    * [Подключение к АТС с помощью SSH-клиента (Putty)](faq/troubleshooting/podklyuchenie-k-ats-s-pomoshyu-ssh/connecting-to-a-pbx-using-an-ssh-client.md)
    * [Подключение с помощью SSH (Windows)](faq/troubleshooting/podklyuchenie-k-ats-s-pomoshyu-ssh/podklyuchenie-s-pomoshyu-ssh-windows.md)
    * [Подключение с помощью SSH (Linux/MacOS)](faq/troubleshooting/podklyuchenie-k-ats-s-pomoshyu-ssh/podklyuchenie-s-pomoshyu-ssh-linux-macos.md)
