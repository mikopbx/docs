...
* [Даигностика проблем](faq/troubleshooting/README.md)
  ...
  * [Подключение к АТС с помощью SSH](faq/troubleshooting/connecting-to-a-pbx-using-an-ssh-client/README.md)
    * [Подключение к АТС с помощью SSH-клиента (Putty)](faq/troubleshooting/connecting-to-a-pbx-using-an-ssh-client/putty.md)
    * [Подключение с помощью SSH (Windows)](faq/troubleshooting/connecting-to-a-pbx-using-an-ssh-client/powershell.md)
    * [Подключение с помощью SSH (Linux/MacOS)](faq/troubleshooting/connecting-to-a-pbx-using-an-ssh-client/podklyuchenie-s-pomoshyu-ssh-linux-macos.md)
